...
class XOLeaderboardAdapter extends RecyclerView.Adapter {
    List<User> leaderboard;
    public XOLeaderboardAdapter(List<User> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new XOLeaderboardAdapter.UserViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        XOLeaderboardAdapter.UserViewHolder uvh = (XOLeaderboardAdapter.UserViewHolder) holder;
    ...
    private static class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(User user) {
            ...
            scoreView.setText(Integer.toString(user.getScores().get(0)));
        }
    }
}
