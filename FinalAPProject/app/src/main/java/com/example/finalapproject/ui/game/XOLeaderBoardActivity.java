...
public class XOLeaderBoardActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Comparator<User> comparator = new Comparator<User>() {
            ...
            public int compare(User o1, User o2) {
                if (o1.getScores().get(0) < o2.getScores().get(0)) {
                    return 1;
                } else if (o1.getScores().get(0) > o2.getScores().get(0)) {
                    return -1;
                }
                return 0;
            }
        ...
        XOLeaderboardAdapter xoLeaderboardAdapter = new XOLeaderboardAdapter(lb);
        recyclerView.setAdapter(xoLeaderboardAdapter);
